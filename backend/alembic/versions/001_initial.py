...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "op_type_id",
            sa.Integer(),
            sa.ForeignKey("op_types.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("name", sa.String(), nullable=False, unique=True),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "doc_id",
            sa.Integer(),
            sa.ForeignKey("asset_documents.id", ondelete="CASCADE"),
            primary_key=True,
        ),
    )
    ...
    op.create_table(
        ...
        sa.Column(
            "item_card_num",
            sa.String(),
            sa.ForeignKey("items.number", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("unit_of_measure", sa.String(), nullable=True),
        sa.Column("category", sa.String(), nullable=True),
        ...
        sa.Column(
            "op_type_detail_id",
            sa.Integer(),
            sa.ForeignKey("op_type_details.id", ondelete="SET NULL"),
            nullable=True,
        ),
        sa.Column("doc_type", sa.String(), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column(
            "document_id",
            sa.Integer(),
            sa.ForeignKey("print_documents.id", ondelete="CASCADE"),
            nullable=False,
        ),
        sa.Column("item_name", sa.String(), nullable=True),
        sa.Column("nomenclature_code", sa.String(), nullable=True),
